...
void main() {
  group('VideoFilenameParser Tests', () {
    test('Parses SxxExx TV show filenames correctly', () {
      final parsed = VideoFilenameParser.parse('Breaking.Bad.S01E05.720p.HDTV.x264-CTU.mkv');
    ...
    test('Parses NxN TV show filenames correctly', () {
      final parsed = VideoFilenameParser.parse('Game_of_Thrones_3x09_1080p.mp4');
    ...
    test('Parses Movie with year correctly', () {
      final parsed = VideoFilenameParser.parse('The.Matrix.1999.1080p.BluRay.x264.mp4');
